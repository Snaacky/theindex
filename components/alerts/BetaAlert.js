...
export default function BetaAlert() {
    ...
    if (show) {
        return <div className={"alert alert-dark alert-dismissible show"} role={"alert"}>
            You are viewing a beta-site. Some features may not be fully functional and contain bugs. <a
            href={"https://piracy.moe"} className={"alert-link"}>Click here</a> to go back to the old index.
