...
export default class EditLibrary extends React.Component {
    constructor({libraries, collectionsDatalist, _id, urlId, img, name, nsfw, description, collections}) {
        super({libraries, collectionsDatalist, _id, urlId, img, name, nsfw, description, collections})
        ...
        return <form>
            <div className={"row"}>
                ...
                <div className={"col-12 col-lg-6 mb-3"}>
                    ...
                    <input type={"text"} className={"form-control"} id={"createLibraryInputName"}
                           value={this.state.name}
                           list={"createLibraryInputNameDatalist"} aria-describedby={"createLibraryInputNameHelp"}
                    ...
                    <input type={"text"} className={"form-control"} id={"createLibraryInputURL"}
                           value={this.state.urlId}
                           list={"createLibraryInputURLDatalist"} aria-describedby={"createLibraryInputURLHelp"}
            ...
            <div className="mb-3 form-check">
                <input type="checkbox" className="form-check-input" id="createLibraryInputNSFW"
            ...
            <div className="mb-3">
                <label htmlFor="createLibraryInputDescription" className="form-label">Description</label>
                <textarea className="form-control" id="createLibraryInputDescription" rows="3"
            ...
            <span className={"float-end"}>
                <button className={"btn btn-primary mb-2 me-2"} type="button" onClick={() => this.saveLibrary()}>
