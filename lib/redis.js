...
/**
 * Returns list of item ids, that sponsor
 * @returns {Promise<*>}
 */
export async function getSponsors() {
    return await asyncSetMembers("sponsors")
}

/**
 * Adds item to sponsor list
 * @param id
 * @returns {Promise<*>}
 */
export async function addSponsor(id) {
    return await asyncSetAdd("sponsors", id)
}