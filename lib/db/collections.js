...
export async function getCollections() {
    return await getAll("collections")
}

export async function getCollection(_id) {
    return await findOne("collections", {_id})
}

export async function addCollection(urlId, img, name, nsfw, description, columns, items) {
    if (!urlId || !name) {
...
export async function updateCollection(_id, {urlId, img, name, nsfw, description, columns, items}) {
    if (!_id) {
