...
export async function addLibrary(urlId, name, nsfw, description, collections) {
    if (!urlId || !name) {
...
export async function updateLibrary(_id, {urlId, name, nsfw, description, collections, order}) {
    if (!_id) {
