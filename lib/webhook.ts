      ...
      embeds: [
        {
          ...
          fields: Object.keys(data)
            ...
            .filter((result) => {
              ...
              return result.old.some(
                (value, index) => result.updated[index] !== value
              )
            })
            .map(({ column, old, updated }) => {
              ...
              switch (column.type) {
                ...
                case ColumnType.proAndCon:
                  ...
                  newValue =
                    updated !== null ? column.values[updated ? 0 : 1] : null
                  break
                case ColumnType.language:
                  oldValue =
                    old !== null && old.length > 0
                      ? old.map(
                          (langKey) =>
                            languages.find((lang) => lang.iso6393 === langKey)
                              .name
                        )
                      : null
                  newValue =
                ...
                case ColumnType.array:
                  ...
                  newValue =
                    updated !== null && updated.length > 0 ? updated : null
                  break
